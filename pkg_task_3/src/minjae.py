...
def main(args=None):
    ...
    # ✅ 배포용: 이 파일 기준으로 ./path 폴더를 참조
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    PATH_DIR = os.path.join(BASE_DIR, "path")
    p = lambda name: os.path.join(PATH_DIR, name)

    cars_config = [
        (1, p('path3_1.json'), p('path3_1_zone.csv'), p('path_hv_3_1.csv'), p('path3_1_out_zone.csv'), p('path_hv_3_2.csv')),
        (2, p('path3_2.json'), p('path3_2_zone.csv'), p('path_hv_2_1.csv'), p('path3_2_out_zone.csv'), p('path_hv_2_2.csv')),
        (3, p('path3_3.json'), p('path3_3_zone.csv'), p('path_hv_2_1.csv'), None,                  p('path_hv_2_1.csv')),
        (4, p('path3_4.json'), p('path3_4_zone.csv'), p('path_hv_3_1.csv'), None,                  p('path_hv_3_1.csv')),
    ]
